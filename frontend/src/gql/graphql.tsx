...
export type UpdateUserProfileMutation = {
  __typename?: 'Mutation';
  updateUser: { __typename?: 'User'; id: number; fullname: string; bio?: string | null; image?: string | null };
};
...
export type LoginUserMutation = {
  ...
  login: {
    __typename?: 'LoginResponse';
    user?: { __typename?: 'User'; email: string; id: number; fullname: string } | null;
  };
};
...
export type RegisterUserMutation = {
  ...
  register: {
    __typename?: 'RegisterResponse';
    user?: { __typename?: 'User'; id: number; fullname: string; email: string } | null;
  };
};
