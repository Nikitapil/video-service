            ...
            <div className="mt-8 md:flex gap-6 ">
              {!fileDisplay && (
                ...
                >
                  ...
                  <div className="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#f02c56]">Select file</div>
                  ...
                  >
                    ...
                    <div className="absolute -bottom-12 flex items-center justify-between border-gray-300 w-full p-2 border rounded-xl z-50">
                      <div className="flex justify-between truncate">
                        ...
                        />
                        <div className="text-[11px] pl-1 truncate text-ellipsis">{fileData?.name}</div>
                      </div>
                      <button
                        className="text-[11px]"
                        onClick={clearVideo}
