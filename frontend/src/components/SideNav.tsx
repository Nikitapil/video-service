  ...
  return (
    <div className="lg:w-[310px] fixed z-20 bg-white pt-[70px] h-full lg:border-r-0 border-r overflow-auto">
      <div className="lg:w-full w-[55px] mx-auto">
        <Link to="/">
          <MenuItem Icon={AiFillHome} color="#F02C56" size="30" text="For you"/>
        </Link>

        <MenuItem Icon={BiGroup} color="#000" size="27" text="Following"/>

        <MenuItem Icon={RiLiveLine} color="#000" size="27" text="LIVE"/>
